...
const BOXES: Box[] = [
  { cat: "GROUND TRUTH", title: "Human Expert", x: 340, y: 30, w: 320, h: 100, emphasize: true },
      ...
      >
        <defs>
          <marker id="ah" markerWidth="10" markerHeight="10" refX="7" refY="3" orient="auto-start-reverse" markerUnits="userSpaceOnUse">
            <path d="M0.5,0.5 L7,3 L0.5,5.5" fill="none" stroke="#8f8f8f" strokeWidth="1.3" />
          </marker>
          <marker id="ahb" markerWidth="10" markerHeight="10" refX="7" refY="3" orient="auto-start-reverse" markerUnits="userSpaceOnUse">
            <path d="M0.5,0.5 L7,3 L0.5,5.5" fill="none" stroke="#c9c9c9" strokeWidth="1.3" />
          </marker>
        </defs>

        {/* arrows: expert -> others (brighter, dashed) */}
        <line x1="404" y1="130" x2="236" y2="216" stroke="#b5b5b5" strokeWidth="1.4" strokeDasharray="7 5" markerEnd="url(#ahb)" />
        <line x1="596" y1="130" x2="764" y2="216" stroke="#b5b5b5" strokeWidth="1.4" strokeDasharray="7 5" markerEnd="url(#ahb)" />
        <line x1="500" y1="130" x2="500" y2="426" stroke="#b5b5b5" strokeWidth="1.4" strokeDasharray="7 5" markerEnd="url(#ahb)" />

        {/* episodes (solid, double) */}
        <line x1="332" y1="270" x2="668" y2="270" stroke="#8f8f8f" strokeWidth="1.5" markerStart="url(#ah)" markerEnd="url(#ah)" />

        {/* decisions (double) */}
        <line x1="170" y1="322" x2="170" y2="428" stroke="#8f8f8f" strokeWidth="1.5" markerStart="url(#ah)" markerEnd="url(#ah)" />
        ...
        {BOXES.map((b) => {
          ...
          return (
            <g key={b.title}>
              ...
              {b.sub ? (
                <text x={cx} y={b.y + 83} textAnchor="middle" fontSize="13" fill="#9a9a9a">
                  {b.sub}
                </text>
              ) : null}
            </g>
        ...
        {/* arrow labels */}
        <text x="300" y="160" textAnchor="middle" fontSize="13" fill="#9a9a9a">f1/f2/f3</text>
        <text x="700" y="160" textAnchor="middle" fontSize="13" fill="#9a9a9a">e</text>
